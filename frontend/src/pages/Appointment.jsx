          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              >
                <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-slate-200 dark:border-slate-700">
                    <h3 className="flex items-center gap-2 text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2.5 sm:mb-3">
                      <Stethoscope size={18} className="text-blue-500 flex-shrink-0" />
                      <span className="truncate">About</span>
                    </h3>
                    <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed line-clamp-2 sm:line-clamp-none">
              ...
              >
                ...
                <div className="space-y-2.5 sm:space-y-3 lg:grid lg:grid-cols-3 lg:gap-4 lg:space-y-0">
                  {[
              ...
              >
                ...
                <div className="mb-5 sm:mb-8">
                  <h4 className="text-sm sm:text-base font-semibold text-slate-700 dark:text-slate-300 mb-2.5 sm:mb-3">
                    Choose a Date
                  </h4>
                  <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-2 sm:pb-3 scrollbar-hide -mx-4 sm:mx-0 px-4 sm:px-0">
                    {docSlots.length > 0 && docSlots.map((item, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`flex flex-col items-center justify-center min-w-[64px] sm:min-w-[80px] md:min-w-[95px] p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl cursor-pointer transition-all ${
                            slotIndex === index
                ...
                <div>
                  <div className="flex items-center justify-between mb-2 sm:mb-3 gap-2">
                    <h4 className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-300">
                      ...
                      <span className="hidden sm:inline">Available Slots</span>
                    </h4>
                  ...
                  {isLoading ? (
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-1.5 sm:gap-2">
                      {Array(12).fill().map((_, i) => (
                        <div key={i} className="h-10 sm:h-12 bg-slate-100 dark:bg-slate-700 rounded-lg animate-pulse"></div>
                      ))}
                    </div>
                  ) : docSlots[slotIndex]?.length > 0 ? (
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-1.5 sm:gap-2">
                      {docSlots[slotIndex].map((item, index) => (
                        <motion.button
                          ...
                          className={`relative p-2 sm:p-3 rounded-lg text-center cursor-pointer transition-all ${
                            item.time === slotTime
                              ? "bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-lg"
                              : item.isPopular
                        ...
                        >
                          ...
                          {item.isPopular && (
                            <div className="text-xs text-amber-600 dark:text-amber-400 mt-0.5 leading-tight">
                              Pop
                            </div>
                          )}
                        </motion.button>
                ...
                <AnimatePresence>
                  {slotTime && (
                    <motion.div
                      ...
                      className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-200 dark:border-slate-700"
                    >
